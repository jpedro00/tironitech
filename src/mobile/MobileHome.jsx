      ...
      <main className="mobile-main">
        ...
        <section className="mobile-section" id="servicos">
          <div className="mobile-section-head">
            ...
            <p>
              Mantendo a identidade visual da Tironi Tech, mas com uma estrutura própria para celular, mais leve, clara e
              portátil.
            </p>
          </div>
        ...
        <section className="mobile-section" id="destaques">
          <div className="mobile-section-head">
            ...
            <p>
              Tempo de mercado, clareza comercial, evolução contínua e construção digital com foco em presença premium.
            </p>
          </div>
        ...
        <section className="mobile-section" id="projetos">
          <div className="mobile-section-head">
            ...
            <p>
              Os projetos abaixo mantêm a hierarquia de informação do desktop, mas com leitura, toque e navegação
              melhores para celular.
            </p>
          </div>
